                            ...
                            <div class="card-body " id="bar-parent">
                                ...
                                {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <input name="title" value="{{$videos->title}}" type="text" class="form-control" id="simpleFormEmail"
                                               placeholder=" Video Title ">
                                    </div>
                                    <div class="form-group">
                                        <label for="simpleFormEmail"> Link</label>
                                        <input value="{{$videos->link}}"  name="link" type="text" class="form-control" id="simpleFormEmail"
                                               placeholder=" Video Link ">
                                    </div>
                                    <div class="form-group">
                                        <label for="simpleFormPassword">Detail</label>
                                        <textarea name="detail" id="summernote" cols="30" rows="10">{{$videos->detail}}</textarea>
                                    </div>
