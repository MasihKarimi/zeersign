                            ...
                            <div class="card-body " id="bar-parent">
                                <form action="{{route('admin.video.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="title" type="text" class="form-control" id="simpleFormEmail"
                                               placeholder="Video Title ">
                                    </div>
                                    <div class="form-group">
                                        <label for="simpleFormEmail"> Path</label>
                                        <input name="link" type="text" class="form-control" id="simpleFormEmail"
