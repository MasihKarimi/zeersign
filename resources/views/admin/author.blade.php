                ...
                <div class="page-bar">
                    <div class="page-title-breadcrumb">
                        ...
                        <ol class="breadcrumb page-breadcrumb pull-right">
                            ...
                            <li><a class="parent-item" href="#">Author</a>&nbsp;<i class="fa fa-angle-right"></i>
                            </li>
                ...
                <div class="row" style="margin-left: 120px; margin-right: 120px;">
                    ...
                    <div class="col-md-12 col-sm-6" >
                        <div class="card card-box">
                            <div class="card-head">
                                <header style="color:#133984  ;">Author Form</header>
                            ...
                            <div class="card-body " id="bar-parent">
                                <form action="{{route('admin.auth.store')}}" method="post" enctype="multipart/form-data">
                                    {{csrf_field()}}
